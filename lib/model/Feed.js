...
function Feed(values) {
    ...
    this.rate = DataUtils.setFloat(objValues.rate, null);
    this.date = DataUtils.setDate(objValues.date, null);
...
Feed.prototype = {
    ...
    validate: function() {
        ...
        if(this.rate === null) { arrErrors.push('Rate cannot be null'); }
        if(this.date === null) { arrErrors.push('Date cannot be null'); }
