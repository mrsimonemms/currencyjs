...
function calculateRates(objFrom, objTo) {
    ...
    var fromRate = objFrom.getRate();
    var toRate = objTo.getRate();
...
Convert.prototype = {
    ...
    calculate: function(value) {
        ...
        this.toValue = DataUtils.setFloat(this.getRate() * this.getFromValue(), 0);
    ...
    calculateReverse: function(value) {
        ...
        this.fromValue = DataUtils.setFloat(this.getToValue() * this.getReverseRate(), 0);
