...
describe('Integration tests', function() {
    ...
    describe('Tests on MongoDB', function() {
        ...
        describe('multiple queries', function() {
            ...
            it('should return all the requested currencies with no error', function(done) {

                objCurrencyMongo.getAllCurrencies(function(err, arrCurrencies) {

                    expect(err).to.be.null;

                    expect(arrCurrencies).to.be.an("array").to.have.length.above(0);

                    var base = arrCurrencies.shift();

                    async.each(arrCurrencies, function(item, callback) {

                        objCurrencyMongo.convert(base, item, function(err, objConvert) {
                            expect(err).to.be.null;
    ...
    describe('Tests on MySQL', function() {
        ...
        describe('multiple queries', function() {
            ...
            it('should return all the requested currencies with no error', function(done) {
                ...
                objCurrencyMySQL.getAllCurrencies(function(err, arrCurrencies) {
                    ...
                    async.each(arrCurrencies, function(item, callback) {
                        ...
                        objCurrencyMySQL.convert(base, item, function(err, objConvert) {
                            expect(err).to.be.null;
